...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        final String SQL_CREATE_ATTENDANCE_TABLE = "CREATE TABLE " + DatabaseEntry.TABLE_NAME + " (" +
                DatabaseEntry._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                DatabaseEntry.NAME + " VARCHAR NOT NULL, " +
                DatabaseEntry.DETAILS + " VARCHAR NOT NULL"+
                "); ";
